...
from .models import bookfreeclass, feedbackform,gallery,contactform,featuredCourse,popularCourse,teacher
...
def index(request):
 ...
 if request.method == 'POST' and 'bookfreeclassess' in request.POST:
        ...
        bookfreeclassess = bookfreeclass(
            name=name,
            email=email,
